            ...
            <form action="{{ route('menus.update', $menu) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea class="w-full rounded-lg border border-gray-200 p-3 text-sm" placeholder="Description of menu ..."
                        rows="8" id="description" name="description">{{ $menu->description }}</textarea>
                </div>
