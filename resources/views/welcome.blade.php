...
@section('content')
    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                <span class="ml-3 text-xl">WaroengKoe</span>
            </a>
    ...
    <section class="text-gray-600 body-font mb-16">
        <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Selamat Datang di Foodcourt Kami!
                </h1>
                <p class="mb-8 leading-relaxed">Temukan sensasi kuliner yang menggugah selera di Foodcourt kami. Dari
                    makanan Asia autentik hingga hidangan Barat modern, kami hadir dengan beragam outlet makanan yang
                    menawarkan cita rasa yang Anda inginkan.
                </p>
                <button
    ...
    <section class="text-gray-600 body-font mb-16">
        <div class="container px-5 mx-auto">
            <div class="flex flex-col text-center w-full mb-8">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Outlet
                </h1>
            </div>
            <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                <div class="sm:w-1/2 mb-10 px-4">
                    ...
                    <p class="leading-relaxed text-base">Williamsburg occupy sustainable snackwave gochujang. Pinterest
    ...
    <section class="text-gray-600 body-font mb-24">
        <div class="container px-5 mx-auto flex flex-wrap">
            <div class="flex flex-col text-center w-full mb-8">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Menu
                </h1>
            </div>
            ...
            <button
                class="flex mx-auto mt-8 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Pesan
                Sekarang</button>
        </div>
    </section>
